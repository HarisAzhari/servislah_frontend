  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        ...
        {isThisItemLoading && <MiniCarLoading className="opacity-80" />}
      </div>
    </Link>
  );
};
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const { logoutMutation, user, isLoading: userLoading } = useAuthTanstack();
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div
            className="absolute top-40 right-32 w-1 h-1 bg-indigo-300 rounded-full animate-pulse"
            style={{ animationDelay: "0.5s" }}
          ></div>
          <div
            className="absolute bottom-32 left-40 w-1.5 h-1.5 bg-blue-300 rounded-full animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-20 right-20 w-1 h-1 bg-indigo-400 rounded-full animate-pulse"
        ...
        <div className="flex flex-col items-center space-y-8 relative z-10">
          ...
          <div className="relative w-32 h-20 mb-4">
            ...
            <div className="absolute bottom-2 left-0 right-0 h-2 bg-gradient-to-r from-gray-300 via-gray-400 to-gray-300 rounded-full overflow-hidden shadow-lg">
              ...
              <div
                className="absolute top-1/2 right-1/4 w-4 h-0.5 bg-white opacity-60 animate-[roadMarkings_1.5s_linear_infinite]"
            ...
            <div className="absolute top-4 left-4 opacity-60">
              <div className="flex space-x-2">
                <div
                  className="w-6 h-1 bg-blue-400/70 rounded animate-[speedLine_1s_linear_infinite]"
                  style={{ animationDelay: "0s" }}
                ></div>
                <div
                  className="w-4 h-1 bg-blue-300/60 rounded animate-[speedLine_1s_linear_infinite]"
                  style={{ animationDelay: "0.1s" }}
                ></div>
                <div
                  className="w-3 h-1 bg-blue-200/50 rounded animate-[speedLine_1s_linear_infinite]"
            ...
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 animate-[carBounce_0.8s_ease-in-out_infinite_alternate]">
              <svg
                ...
                viewBox="0 0 64 40"
                fill="none"
                className="animate-[carShine_3s_ease-in-out_infinite] drop-shadow-lg"
              >
                <defs>
                  <linearGradient
                    id="dashboardCarGradient"
                    x1="0%"
                    y1="0%"
                    x2="100%"
                    y2="0%"
                  ...
                  >
                    <stop
                      offset="0%"
                      style={{ stopColor: "#87CEEB", stopOpacity: 0.9 }}
                    />
                    <stop
                      offset="100%"
                      style={{ stopColor: "#4FC3F7", stopOpacity: 0.7 }}
                    />
                  </linearGradient>
                ...
                <ellipse
                  ...
                  fill="#000000"
                  opacity="0.2"
                  className="animate-[shadowPulse_0.8s_ease-in-out_infinite_alternate]"
                />

                {/* Car body */}
                <path
                  d="M16 16 L48 16 L56 24 L56 32 L52 32 L52 28 L12 28 L12 32 L8 32 L8 24 L16 16 Z"
                  fill="url(#dashboardCarGradient)"
                  filter="url(#dashboardGlow)"
                />

                {/* Car top */}
                <path
                  d="M20 8 L44 8 L48 16 L16 16 L20 8 Z"
                  fill="url(#dashboardCarGradient)"
                  opacity="0.95"
                />
                ...
                <path
                  d="M22 10 L42 10 L45 15 L19 15 L22 10 Z"
                  fill="url(#windowGradient)"
                />
                <path
                  d="M22 10 L32 10 L32 15 L19 15 L22 10 Z"
                  fill="#FFFFFF"
                  opacity="0.3"
                />
                ...
                <circle
                  ...
                  r="5"
                  fill="#2D3748"
                  className="animate-[wheelSpin_0.4s_linear_infinite]"
                />
          ...
          <div className="text-center space-y-2">
            ...
            <div className="flex items-center justify-center space-x-1">
              ...
              <div className="flex space-x-1">
                <div
                  className="w-1.5 h-1.5 bg-blue-500 rounded-full animate-[dotBounce_1.4s_ease-in-out_infinite]"
                  style={{ animationDelay: "0s" }}
                ></div>
                <div
                  className="w-1.5 h-1.5 bg-indigo-500 rounded-full animate-[dotBounce_1.4s_ease-in-out_infinite]"
                  style={{ animationDelay: "0.2s" }}
                ></div>
                <div
                  className="w-1.5 h-1.5 bg-blue-600 rounded-full animate-[dotBounce_1.4s_ease-in-out_infinite]"
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-center h-16 px-4 border-b border-gray-200/50 dark:border-gray-700/50 relative">
            ...
            >
              ...
              <span
                className={`text-lg font-bold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-all duration-300 ${
          ...
          {/* Quick Stats */}
          <div
            className={`px-4 py-3 border-b border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 ${
              isSidebarCollapsed ? "lg:hidden" : ""
            }`}
          >
          ...
          <div className="p-4 border-t border-gray-200/50 dark:border-gray-700/50">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className={`w-full h-auto p-3 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 dark:hover:from-gray-800 dark:hover:to-blue-900/50 transition-all duration-300 rounded-xl group ${
                    isSidebarCollapsed ? "justify-center" : "justify-start"
                  }`}
                >
                  <Avatar
                    className={`ring-2 ring-transparent group-hover:ring-blue-200 dark:group-hover:ring-blue-700 transition-all duration-300 ${
                      isSidebarCollapsed ? "h-8 w-8" : "h-10 w-10 mr-3"
                    }`}
                  >
                    <AvatarImage
                      src={
                  ...
                  >
                    <p className="text-sm font-medium group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                      {displayName}
                    </p>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 border-gray-200/50 dark:border-gray-700/50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm"
              >
                ...
                <DropdownMenuItem
                  ...
                  className="text-red-600 dark:text-red-400 hover:bg-gradient-to-r hover:from-red-50 hover:to-red-100 dark:hover:from-red-900/50 dark:hover:to-red-800/50 transition-all duration-200"
                >
            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4 ml-auto">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="relative hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 dark:hover:from-gray-800 dark:hover:to-blue-900/50 transition-all duration-300 hover:scale-105 group"
                >
                ...
                <div className="hidden lg:block">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="flex items-center space-x-3 hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 dark:hover:from-gray-800 dark:hover:to-blue-900/50 transition-all duration-300 rounded-xl group"
                      >
                        ...
                        <span className="text-sm font-medium hidden md:block group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                          {displayName}
                        </span>
                      </Button>
                    </DropdownMenuTrigger>
