      ...
      <Tabs defaultValue="account" className="space-y-6">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                {Object.entries({
                  ...
                  <div key={key} className="flex items-center justify-between p-4 rounded-lg border border-gray-200/50 bg-gray-50/50">
        ...
        <TabsContent value="privacy" className="space-y-6">
          <Card className="bg-white/80 backdrop-blur-sm border-gray-200/50">
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="p-4 rounded-lg border border-gray-200/50 bg-gray-50/50">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200/50 bg-gray-50/50">
                  <div className="space-y-1">
                    <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    className={privacy.showEmail ? "bg-green-600 hover:bg-green-700" : "hover:bg-gray-100"}
                  >
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border border-gray-200/50 bg-gray-50/50">
                  ...
                  <Button
                    ...
                    className={privacy.allowAnalytics ? "bg-blue-600 hover:bg-blue-700" : "hover:bg-gray-100"}
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      >
                        <Icon className={`h-6 w-6 mx-auto mb-2 ${theme === value ? 'text-blue-600' : 'text-gray-400'}`} />
                        <span className={`text-sm font-medium ${theme === value ? 'text-blue-600' : 'text-gray-600'}`}>
                          {label}
                        </span>
                      </button>
                    ))}
